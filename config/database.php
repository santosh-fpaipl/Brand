    ...
    */
    ...
    'connections' => [
        ...
        'delivery_db' => [
            ...
            'host' => env('DELIVERY_DB_HOST', '127.0.0.1'),
            'port' => env('DELIVERY_DB_PORT', '3306'),
            'database' => env('DELIVERY_DB_DATABASE', 'forge'),
            'username' => env('DELIVERY_DB_USERNAME', 'forge'),
            'password' => env('DELIVERY_DB_PASSWORD', ''),
            'unix_socket' => env('DELIVERY_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
